...
var Main = function() {
	...
	panel1.addRange("Range",0,100,30,1,function(value) {
		_gthis.output("Range",value == null?"null":"" + value);
	});
	panel1.addNumber("Number",0,100,50,1,function(value1) {
		_gthis.output("Number",value1 == null?"null":"" + value1);
	});
	panel1.addColor("Color","#ff0000",function(value2) {
		_gthis.output("Color",value2 == null?"null":"" + value2);
	});
	panel1.addBoolean("Boolean",true,function(value3) {
		_gthis.output("Boolean",value3 == null?"null":"" + value3);
	});
	panel1.addText("Text","some text",function(value4) {
		_gthis.output("Text",value4 == null?"null":"" + value4);
	});
	panel1.addTextArea("TextArea","a whole bunch of text can go here",function(value5) {
		_gthis.output("TextArea",value5 == null?"null":"" + value5);
	});
	panel1.addButton("Button",function() {
